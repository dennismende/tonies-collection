...
| SPEC-SEARCH-FILTER | 1.1.0 | `search-filter.v1.1.0.md` | Search & filter (name, series, favorite) | `src/components/filter-bar.tsx`, `src/app/page.tsx` | `e2e/catalog.spec.ts` | Active |
